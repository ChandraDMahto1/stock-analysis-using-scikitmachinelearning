# -*- coding: utf-8 -*-
"""
Created on Sat Apr 04 14:37:25 2015
...
how_much_better = 5   #implies to consider those companies that are 5 % more efficient
...
def Analysis():
    ...
    test_size = 1  #can be set according to the user

    invest_amount = 10000  ##in dollar
...
##### the below portion of code actually runs loop times to ensure the final list of stocks that are to be suggested for investing
final_list = []

loops = 8   #can be set as per the user requirement
